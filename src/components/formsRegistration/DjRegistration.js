...
const DjRegistration = ({ onSetModal }) => {
  // Inputs
  ...
  return (
    ...
    <form className="form_modal_global" >
      <h3>DJ Registration</h3>
      <AiFillCloseCircle className="close" onClick={() => onSetModal(false)} />
    <iframe src="https://my.forms.app/ptitcomsa/djregistration" height="100%" width="100%" frameborder="0" allowfullscreen loading='eager'></iframe>
    </form>
  );
};
