  ...
  return (
    <Container tailwindClasses="flex items-center justify-center relative pb-20">
      <div className="flex flex-col items-center justify-center pt-10">
        ...
        <p className="px-2 md:w-5/12 pt-10 text-center text-2xl">
          <Trans i18nKey="step3.workingOnIt">
            Our team will review your application as soon as possible, if
            accepted, you will be sent a link to pay securely within{" "}
            {{ checkout_valid_for }} hours.
          </Trans>
        </p>
        <p className="px-2 md:w-5/12 pt-10 text-center text-2xl">
          {t("step3.messageUsOnInstagram")}
        </p>
        <a
